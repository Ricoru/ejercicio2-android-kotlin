...
class PopularesFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        lista.add(
            RestauranteEntity("Mi Restaurant 3", 1f,
                R.drawable.ic_login, "Sin detalle")
        )
        lista.add(
            RestauranteEntity("Mi Restaurant 4", 3f,
                R.drawable.ic_login, "Sin detalle")
        )
        lista.add(
        ...
        lista.add(
            RestauranteEntity("Mi Restaurant 6", 2f,
                R.drawable.ic_login, "Sin detalle")
        )
        lista.add(
            RestauranteEntity("Mi Restaurant 8", 1f,
                R.drawable.ic_login, "Sin detalle")
        )
        lista.add(
            RestauranteEntity("Mi Restaurant 9", 3f,
                R.drawable.ic_login, "Sin detalle")
        )
